...
export default function Header() {
  return (
    <header className=" w-[99.5%] justify-between fixed flex z-10 h-[7em] max-md:h-[6em] mx-[.2em] bg-[#ff72dc]">
     ...
     <section className="max-md:flex hidden gap-[1.5em]">
      ...
      <Link to="/"><h4 className="font-bold text-[#f3e9ff] mt-[.7em]"><SiMailchimp size={28}/>Mail</h4></Link>
     <Link to="/"><h4 className="mr-[2em] text-[#f3e9ff] mt-[.7em] font-bold"><GiRamProfile size={28}/> Profile</h4></Link>
     </section>
